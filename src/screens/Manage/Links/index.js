    ...
    <Layout>
      ...
      <div className="alert alert-danger rounded float-center shadow-bold">
        ...
        <div className="d-flex justify-content-between">
          ...
          <button className="btn dtn-danger" onClick={confirmDelete}>delete</button>
        </div>
      </div>
      ) : null };
    </Layout>
...
const mapStateToProps = (state) => {
  return { 
    links: state.link.link,
    linkToRemove: state.link.linkToRemove
  };
};

export default connect(mapStateToProps, { linkList, linkRemove, setLinkToRemove })(Links);